...
#include "mygraph.h"
/*
 * viết một hàm kiểm tra xem hai từ có liên quan với nhau hay không
 */
...
/*
 * khi kiểm tra hai từ có liên quan với nhau hay không string1 string2
 * 1 đọ dài của hai từ khác nhau lớn hơn hai đơn vị accc ac return 0 ( không liên quan  với nhau)
 * 2 độ dài hai xâu bằng nhau acb adc
 * 3 một xâu có độ dài n một xâu có độ dài n+1
 * abc a
 */
